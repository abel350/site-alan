...
<head>
  ...
  <body>
    <div id="loader"></div>
    <div id="mostrarmodal" class="modal container fade" tabindex="-1" data-focus-on="input:first" style="width:400px; height: 400px;">
     
      <div class="modal-body">
        <iframe width="100%" height="280" src="https://www.youtube.com/embed/gOtGahSJdE0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>    
      <div class="modal-footer">
        <!-- Make sure to include the 'nothanks' class on the buttons -->
        <button class="btn btn-default nothanks" data-dismiss="modal" aria-hidden="true">Don't Show Again</button>
        <button class="btn btn-primary" data-dismiss="modal" aria-hidden="true">Watch Later</button>
      </div>       
    </div> 
