    ...
    <body>
      <div id="main" class="animate-bottom">
          ...
          <div class="container-fluid">
            ...
            <div id="slidemenu">           
              <ul class="nav navbar-nav navbar-left">
                ...
                <li class="active"><a id="about" href ="tutorial.php">Tutorial</a></li>
        ...
        <div class="container">
          <div class="row">
           <div class="col-md-6">
            <iframe width="100%" height="415" src="https://www.youtube.com/embed/gOtGahSJdE0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          </div>
