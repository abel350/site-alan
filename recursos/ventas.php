...
$tamanoGET = $_GET["Tamano"]; 
$etiquetaGET = $_GET["Etiqueta"];
$codigoGET = $_GET["CodigosCarga"];

//$resultado = str_replace(" ", "+", $etiquetaGET);

$data_string = "?Tamano=".$tamanoGET."&Etiqueta=".$etiquetaGET."&CodigosCarga=".$codigoGET;
