...
<head>
  ...
  <link rel="stylesheet" href="dist/css/table_fixed.css">
  ...
  <body>
    ...
    <div id="main" class="animate-bottom">
        ...
        <div class="container-fluid">
          ...
          <div id="slidemenu">           
            <ul class="nav navbar-nav navbar-left">
              ...
              <li class="active"><a id="lloads" href ="loads.php">Loads</a></li>
              <li class="dropdown">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          ...
          <a data-toggle="modal" href="#stack8" class=""><i class="fa fa-info-circle info" aria-hidden="true"></i></a>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 "> 
          <div id="tabla_loads" class="tabla_fixed"></div>
        </div>                        
      </div><!-- /div .row -->
    </div><!-- /div .container -->
    ...
    <div id="loads" class="modal container fade" tabindex="-1" data-focus-on="input:first" style="height: 500px;">
      ...
      <div class="modal-body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 ">            
          <div id="status_load" style="overflow-x:auto; overflow-y:auto;"></div>
        </div>       
      </div>        
    </div>
  ...
  <!-- Funciones -->
  <script src="translate/traducir_loads.js"></script>
  <script src="http://malsup.github.io/jquery.blockUI.js"></script>
  <script src="https://unpkg.com/i18next@8.4.3/i18next.min.js"></script>
  <script src="dist/js/casos.js"></script>
